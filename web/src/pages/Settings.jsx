...
export default function Settings() {
  ...
  const handleAlertSettingChange = (key, value) => setAlertSettings((prev) => ({ ...prev, [key]: value }));
  const handleSystemSettingChange = (key, value) => setSystemSettings(prev => ({ ...prev, [key]: value }));
  const handleAiSettingChange = (key, value) => setAiSettings(prev => ({ ...prev, [key]: value }));
  ...
  return (
    <div className="px-3 sm:px-6 pt-6 pb-10 text-slate-900">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
        {/* Alert Preferences */}
        <div className={`${cardBase} transition-all ${entered ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"}`} style={{ transitionDelay: "60ms" }}>
          ...
          <div className="space-y-4">
            <div>
              ...
              <select className={`${inputBase} bg-transparent text-gray-900`} value={alertSettings.sensitivity} onChange={(e) => handleAlertSettingChange("sensitivity", e.target.value)}>
            ...
            <button onClick={() => saveSettings("alert")} className="w-full mt-4 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg transition-colors">
              Save Preferences
            </button>
          </div>
        </div>
        ...
        <div className={`${cardBase} transition-all ${entered ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"}`} style={{ transitionDelay: "90ms" }}>
          ...
          <div className="space-y-4">
            <div>
              ...
              <select className={inputBase} value={systemSettings.retentionPeriod} onChange={(e) => handleSystemSettingChange("retentionPeriod", e.target.value)}>
            ...
            <div>
              ...
              <select className={inputBase} value={systemSettings.autoLogout} onChange={(e) => handleSystemSettingChange("autoLogout", e.target.value)}>
            ...
            <div>
              ...
              <select className={inputBase} value={systemSettings.videoQuality} onChange={(e) => handleSystemSettingChange("videoQuality", e.target.value)}>
            ...
            <button onClick={() => saveSettings("system")} className="w-full mt-4 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg transition-colors">
              Save Configuration
            </button>
          </div>
        </div>
        ...
        {/* AI Model Settings */}
        <div className={`${cardBase} transition-all ${entered ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"}`} style={{ transitionDelay: "120ms" }}>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select className={inputBase} value={aiSettings.updateFrequency} onChange={(e) => handleAiSettingChange("updateFrequency", e.target.value)}>
            ...
            <div>
              ...
              <select className={inputBase} value={aiSettings.autoLearning ? "enabled" : "disabled"} onChange={(e) => handleAiSettingChange("autoLearning", e.target.value === "enabled")}>
                <option value="enabled">Enabled (Recommended)</option>
                <option value="disabled">Disabled</option>
              </select>
            </div>

            <button onClick={() => saveSettings("AI model")} className="w-full mt-4 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg transition-colors">
              Save Model Settings
            </button>
          </div>
        </div>
